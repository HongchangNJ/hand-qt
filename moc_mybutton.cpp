...
QT_MOC_LITERAL(1, 9, 10), // "left_slide"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 11) // "right_slide"

    },
    "MyButton\0left_slide\0\0right_slide"
};
...
void MyButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->left_slide(); break;
        case 1: _t->right_slide(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyButton::left_slide)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyButton::right_slide)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyButton::left_slide()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MyButton::right_slide()
{
